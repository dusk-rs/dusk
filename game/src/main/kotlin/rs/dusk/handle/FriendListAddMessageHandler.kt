 ...
 * @created Oct 30, 2020
 */
class FriendListAddMessageHandler : GameMessageHandler<FriendListAddMessage>()
{
    ...
    override fun handle(ctx: ChannelHandlerContext, msg: FriendListAddMessage)
    {
        ...
        contactsImpl.addFriend(player, name)
