...
val doors: Map<Int, Int> = io.read<Map<String, Int>>(getProperty("doorsPath")).mapKeys { it.key.toInt() }
val fences: Map<Int, Int> = io.read<Map<String, Int>>(getProperty("fencesPath")).mapKeys { it.key.toInt() }
