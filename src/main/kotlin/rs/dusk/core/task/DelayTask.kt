package rs.dusk.core.task

import rs.dusk.engine.task.CancelTask
...
fun TaskExecutor.delay(ticks : Int = 0, task : (Long) -> Unit) = DelayTask(tick + ticks, task).apply { execute(this) }