...
import rs.dusk.client.variable.sendVar
...
import rs.dusk.game.container.player.hasFriend
import rs.dusk.game.content.Assistance.getHoursRemaining
import rs.dusk.game.content.Assistance.hasEarnedMaximumExperience
import rs.dusk.game.content.Assistance.toggleInventory
import rs.dusk.game.entity.character.data.skill.Level.message
import rs.dusk.game.entity.character.get
import rs.dusk.game.entity.character.player.Player
import rs.dusk.game.entity.character.player.data.PlayerOption
import rs.dusk.game.entity.character.player.data.delay.Delay
import rs.dusk.game.entity.character.player.data.delay.delayed
import rs.dusk.game.entity.character.player.data.delay.remaining
import rs.dusk.game.entity.character.update.visual.player.name
import rs.dusk.game.entity.character.update.visual.setAnimation
import rs.dusk.game.entity.character.update.visual.setGraphic
